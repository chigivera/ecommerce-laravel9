...
@endif
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="ProductName" name="title" placeholder="Enter Product name">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="file" class="form-control" id="ProductImage" name="image" placeholder="Choose Product image">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="ProductQuantity" name="quantity" placeholder="Enter Product quantity">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="ProductDiscount" name="discount" placeholder="Enter Product discount">
    </div>
